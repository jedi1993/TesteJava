...
public class SigaBemSaida implements Statement, Connection {
    ...
    public SigaBemSaida(double vlrTotalFrete, String DDD, String estado) {
    ...
    public void calculoFrete(SigaBemEntrada sigaBemEntrada){
